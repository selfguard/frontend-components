(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/objectWithoutProperties'), require('@babel/runtime/regenerator'), require('selfguard-client'), require('axios'), require('supertokens-auth-react/recipe/session')) :
    typeof define === 'function' && define.amd ? define(['react', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/objectWithoutProperties', '@babel/runtime/regenerator', 'selfguard-client', 'axios', 'supertokens-auth-react/recipe/session'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["react-awesome-buttons"] = factory(global.React, global._defineProperty, global._asyncToGenerator, global._objectWithoutProperties, global._regeneratorRuntime, global.SelfGuard, global.axios, global.Session));
})(this, (function (React, _defineProperty, _asyncToGenerator, _objectWithoutProperties, _regeneratorRuntime, SelfGuard, axios, Session) { 'use strict';
